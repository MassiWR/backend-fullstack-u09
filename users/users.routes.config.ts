  ...
  configureRoutes(): express.Application {
    this.app
      ...
      .post(
        body("email")
          .isEmail()
          .withMessage(
            "The given email is not valid, please enter a valid email"
          ),
        body("password")
          .isLength({ min: 5 })
          .withMessage("Password minimum length must 5 characters long"),
    ...
    this.app.patch(`/users/:userId`, [
      body("email")
        .isEmail()
        .optional()
        .withMessage("The given email is not valid, please try again"),
      body("password")
        .isLength({ min: 5 })
        .withMessage("Password minimum length must 5 characters long")
        .optional(),
